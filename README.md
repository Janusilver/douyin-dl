...
| 小红书 | 图文无水印原图、动图 mp4、原始无水印视频 | 建议（匿名可能被风控） |
| 快手 | 无水印视频（manifest 原档）、图集 | 建议（匿名可用） |
...
- **图片**：走 CDN token 还原**无水印原图**（自动去掉压缩变换后缀）
- **视频**：优先下载 `originVideoKey` **原始无水印文件**，失败退回 h264/h265 最高清流
